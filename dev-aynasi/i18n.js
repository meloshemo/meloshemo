...
(function (root, factory) {
  ...
  const S = {
    tr: {
      ...
      touchKeys: "Ekrana <b>bas ve sürükle</b>: parmağın hangi yöne giderse oraya yürürsün · <b>Sezgi</b> düğmesi yön gösterir",
      codeLabel: "Salon kodu", codePlaceholder: "örn. 4821", codeApply: "Aç",
      codeRange: "1–99999 arası",
      ...
      roomDone: "Bu odayı bitirdin",
      roomDoneText: "Aynayı buldun ve kapıya döndün. Salon kapanıyor, bir sonraki açılıyor.",
      nextRoom: "Sıradaki oda",
      ...
      autoRes: "Akıcılık önceliği",
      autoResNote: "Oyun kendi kare süresini ölçer ve görüntüyü ekranının kaldırabileceği en yüksek keskinlikte tutar. Kapatırsan çözünürlük sabitlenir.",
    ...
    en: {
      ...
      touchKeys: "<b>Touch and drag</b> anywhere: you walk in the direction your finger moves · the <b>Hunch</b> button points the way",
      codeLabel: "Hall code", codePlaceholder: "e.g. 4821", codeApply: "Open",
      codeRange: "1–99999 only",
      ...
      roomDone: "Room finished",
      roomDoneText: "You found the mirror and made it back to the door. This hall closes; the next one opens.",
      nextRoom: "Next room",
      ...
      ruleNames: {
        mirrorControls: "inverted controls", shiftEvery: "shifting walls", echo: "the echo",
        neon: "neon", water: "water", storm: "sandstorm", grid: "grid",
        openHall: "open gallery", bazaar: "bazaar", stillness: "still water",
        ice: "ice", lantern: "dying lantern", liars: "lying mirrors",
        fleeing: "fleeing mirror", fog: "fog",
      },
      ...
      autoRes: "Prioritise smoothness",
      autoResNote: "The game measures its own frame time and keeps the picture as sharp as your screen can sustain. Turn this off to lock the resolution.",
