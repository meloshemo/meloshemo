...
| --- | --- | --- | --- |
| `dev-aynasi-fragman-tr.webm` | Türkçe | ~52 sn | WebM (VP8), 1280×720, 25 fps, sessiz |
| `dev-aynasi-trailer-en.webm` | English | ~58 s | WebM (VP8), 1280×720, 25 fps, silent |
...
5. III · Ters Salon, IV · Kayan Aynalar, V · Yankı tanıtımı
