...
export const SEED_POLLS: readonly SeedPoll[] = [
  ...
  { slug: "iskender-vs-pide", question: "İskender mi, pide mi?", category: "yemek",
    options: [{ label: "İskender", emoji: "🍽️" }, { label: "Pide", emoji: "🫓" }] },
  { slug: "manti-vs-erişte", question: "Mantı mı, erişte mi?", category: "yemek",
    options: [{ label: "Mantı", emoji: "🥟" }, { label: "Erişte", emoji: "🍜" }] },
  { slug: "kokorec-vs-midye", question: "Gece açsan hangisi?", category: "yemek",
    options: [{ label: "Kokoreç", emoji: "🌯" }, { label: "Midye Dolma", emoji: "🦪" }] },
  { slug: "kumru-vs-tantuni", question: "Kumru mu, tantuni mi?", category: "yemek",
    options: [{ label: "Kumru", emoji: "🥖" }, { label: "Tantuni", emoji: "🌯" }] },
  ...
  { slug: "kuru-fasulye-vs-nohut", question: "Ev yemeği: hangisi?", category: "yemek",
    options: [{ label: "Kuru Fasulye", emoji: "🫘" }, { label: "Nohut", emoji: "🍛" }] },
  { slug: "cig-kofte-vs-icli-kofte", question: "Çiğ köfte mi, içli köfte mi?", category: "yemek",
    options: [{ label: "Çiğ Köfte", emoji: "🌶️" }, { label: "İçli Köfte", emoji: "🥔" }] },
  { slug: "su-boregi-vs-sigara-boregi", question: "Börek: hangisi?", category: "yemek",
    options: [{ label: "Su Böreği", emoji: "🥧" }, { label: "Sigara Böreği", emoji: "🥠" }] },
  { slug: "balik-ekmek-vs-tost", question: "Hızlı bir öğün: hangisi?", category: "yemek",
    options: [{ label: "Balık Ekmek", emoji: "🐟" }, { label: "Kaşarlı Tost", emoji: "🧀" }] },
  ...
  { slug: "sutlac-vs-kazandibi", question: "Sütlü tatlı: hangisi?", category: "tatli",
    options: [{ label: "Sütlaç", emoji: "🍮" }, { label: "Kazandibi", emoji: "🍨" }] },
  { slug: "trilece-vs-magnolia", question: "Yeni nesil tatlı: hangisi?", category: "tatli",
    options: [{ label: "Trileçe", emoji: "🍰" }, { label: "Magnolia", emoji: "🍨" }] },
  { slug: "tulumba-vs-lokma", question: "Şerbetli: tulumba mı, lokma mı?", category: "tatli",
    options: [{ label: "Tulumba", emoji: "🍩" }, { label: "Lokma", emoji: "🍡" }] },
  { slug: "dondurma-maras-vs-sade", question: "Dondurma: hangisi?", category: "tatli",
    options: [{ label: "Maraş", emoji: "🍦" }, { label: "Sade", emoji: "🍨" }] },
  { slug: "katmer-vs-kunefe", question: "Antep'te tek tatlı seçeceksin:", category: "tatli",
    options: [{ label: "Katmer", emoji: "🥮" }, { label: "Künefe", emoji: "🧀" }] },
  ...
  { slug: "boza-vs-salep", question: "Kış içeceği: hangisi?", category: "icecek",
    options: [{ label: "Boza", emoji: "🥛" }, { label: "Salep", emoji: "☕" }] },
  { slug: "cay-demli-vs-acik", question: "Çay nasıl olmalı?", category: "icecek",
    options: [{ label: "Demli", emoji: "🫖" }, { label: "Açık", emoji: "🍵" }] },

  // Şehir
  { slug: "izmir-vs-istanbul", question: "Yaşamak için hangisi?", category: "sehir",
    options: [{ label: "İzmir", emoji: "⛵" }, { label: "İstanbul", emoji: "🌉" }] },
  { slug: "ankara-vs-izmir", question: "Ankara mı, İzmir mi?", category: "sehir",
    options: [{ label: "Ankara", emoji: "🏛️" }, { label: "İzmir", emoji: "⛵" }] },
  { slug: "gaziantep-vs-hatay", question: "Mutfağı daha iyi olan şehir?", category: "sehir",
    options: [{ label: "Gaziantep", emoji: "🥘" }, { label: "Hatay", emoji: "🫓" }] },
  { slug: "trabzon-vs-rize", question: "Karadeniz'de hangisi?", category: "sehir",
    options: [{ label: "Trabzon", emoji: "🏔️" }, { label: "Rize", emoji: "🍃" }] },
  { slug: "bursa-vs-eskisehir", question: "Hafta sonu kaçamağı: hangisi?", category: "sehir",
    options: [{ label: "Bursa", emoji: "🌳" }, { label: "Eskişehir", emoji: "🚋" }] },
  { slug: "konya-vs-kayseri", question: "İç Anadolu'da hangisi?", category: "sehir",
    options: [{ label: "Konya", emoji: "🕌" }, { label: "Kayseri", emoji: "⛰️" }] },

  // Tatil
  { slug: "cesme-vs-bodrum", question: "Tatil için hangisi?", category: "tatil",
    options: [{ label: "Çeşme", emoji: "🏖️" }, { label: "Bodrum", emoji: "🛥️" }] },
  { slug: "kas-vs-kalkan", question: "Akdeniz'de hangisi?", category: "tatil",
    options: [{ label: "Kaş", emoji: "🤿" }, { label: "Kalkan", emoji: "🌅" }] },
  { slug: "yayla-vs-sahil", question: "Yaz tatili: hangisi?", category: "tatil",
    options: [{ label: "Karadeniz Yaylası", emoji: "🏞️" }, { label: "Ege Sahili", emoji: "🏖️" }] },
  { slug: "alacati-vs-datca", question: "Alaçatı mı, Datça mı?", category: "tatil",
    options: [{ label: "Alaçatı", emoji: "🌬️" }, { label: "Datça", emoji: "🫒" }] },
  ...
  { slug: "gobeklitepe-vs-nemrut", question: "Göbeklitepe mi, Nemrut mu?", category: "tarihi-yer",
    options: [{ label: "Göbeklitepe", emoji: "🗿" }, { label: "Nemrut", emoji: "⛰️" }] },
  { slug: "safranbolu-vs-beypazari", question: "Tarihi kasaba: hangisi?", category: "tarihi-yer",
    options: [{ label: "Safranbolu", emoji: "🏘️" }, { label: "Beypazarı", emoji: "🏚️" }] },
  ...
  { slug: "kahvalti-tuzlu-vs-tatli", question: "Kahvaltı: tuzlu mu, tatlı mı?", category: "gunluk-hayat",
    options: [{ label: "Tuzlu", emoji: "🧀" }, { label: "Tatlı", emoji: "🍯" }] },
  { slug: "sabahci-vs-gececi", question: "Sen hangisisin?", category: "gunluk-hayat",
    options: [{ label: "Sabahçı", emoji: "🌅" }, { label: "Gececi", emoji: "🌙" }] },
  { slug: "denize-taslik-vs-kumsal", question: "Denize nereden girilir?", category: "gunluk-hayat",
    options: [{ label: "Taşlık", emoji: "🪨" }, { label: "Kumsal", emoji: "🏖️" }] },
  { slug: "camasir-askida-vs-makine", question: "Çamaşır nasıl kurutulur?", category: "gunluk-hayat",
    options: [{ label: "Askıda", emoji: "🧺" }, { label: "Kurutma makinesi", emoji: "🌀" }] },

  // Ulaşım
  { slug: "metro-vs-vapur", question: "İstanbul'da yolculuk: hangisi?", category: "ulasim",
    options: [{ label: "Metro", emoji: "🚇" }, { label: "Vapur", emoji: "⛴️" }] },
  { slug: "otomatik-vs-manuel", question: "Vites: otomatik mi, manuel mi?", category: "ulasim",
    options: [{ label: "Otomatik", emoji: "🚗" }, { label: "Manuel", emoji: "🕹️" }] },
  { slug: "sahin-vs-dogan", question: "Klasik: Şahin mi, Doğan mı?", category: "ulasim",
    options: [{ label: "Şahin", emoji: "🚙" }, { label: "Doğan", emoji: "🚘" }] },
] as const;
